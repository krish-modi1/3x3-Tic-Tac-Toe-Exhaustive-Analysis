...
**[PLOT 1: Insert `position4_analysis.png` here]**
...
**[PLOT 2: Insert `position4_diff_analysis.png` here]**
...
**[PLOT 3a: Insert Layer 1 heatmap here]**
...
**[PLOT 3b: Insert Layer 3 heatmap here]**
...
**[PLOT 3c: Insert Layer 5 heatmap here]**
...
**[PLOT 4: Insert `position4_l2ref_analysis.png` here]**
...
**[PLOT 5: Insert `position4_fourier_branch.png` here]**
...
**[PLOT 6: Insert `position4_recursive_analysis.png` here]**
...
## Appendix B: Figure Placement Reference

**All plot placeholders are clearly marked with:**
- **[PLOT X: Insert `filename.png` here]**
- **Description of what the plot shows**

There are **6 unique plots** needed:

1. **PLOT 1** (Section 3.1): `position4_analysis.png` — Hierarchical probability progression (3×3 grid)
2. **PLOT 2** (Section 3.1): `position4_diff_analysis.png` — Probability differences across layers (3×3 grid)
3. **PLOT 3a** (Section 3.2): Layer 1 heatmap — Early game square values (single board)
4. **PLOT 3b** (Section 3.2): Layer 3 heatmap — Mid-game square values (single board)
5. **PLOT 3c** (Section 3.2): Layer 5 heatmap — Late-game square values (single board)
6. **PLOT 4** (Section 3.3): `position4_l2ref_analysis.png` — Layer 2 genealogy (3×3 grid)
7. **PLOT 5** (Section 4.1): `position4_fourier_branch.png` — Feature model performance (3×3 grid)
8. **PLOT 6** (Section 4.2): `position4_recursive_analysis.png` — Recursive testing (3×3 grid)
